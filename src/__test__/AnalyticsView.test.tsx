...
jest.mock("../components/view/charts/SpendOverTime", () => () => (
  <div data-testid="spend-over-time-chart" />
));
jest.mock("../components/view/charts/SpendPerCat", () => () => (
  <div data-testid="spend-per-cat-chart" />
));
jest.mock("../components/view/charts/ChangeComparison", () => () => (
  <div data-testid="change-comparison-chart" />
));
jest.mock("../components/view/charts/StackedBarChart", () => () => (
